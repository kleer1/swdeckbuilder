...
import static starwars.deckbuilder.matchers.BetweenMatcher.isBetween;
...
class GameTest {
    ...
    private void assertEmpireStartState() {
        ...
        for (PlayableCard card : player.getHand()) {
            assertThat(card.getId(), isBetween(CardMapping.EmpireStartingCards));
            ...
            assertThat(card.getId(), isBetween(CardMapping.EmpirePlayableCards));
        }
        ...
        assertThat(currentBase.getId(), isBetween(CardMapping.EmpireBases));
        ...
        for (Base base : player.getAvailableBases()) {
            ...
            assertThat(base.getId(), isBetween(CardMapping.EmpireBases));
        }
    ...
    private void assertRebelStartState() {
        ...
        assertStartingDeckSizes(player);
        for (PlayableCard card : player.getHand()) {
            assertThat(card.getId(), isBetween(CardMapping.RebelStartingCards));
            assertThat(card.getLocation(), equalTo(CardLocation.RebelHand));
            assertThat(card.getOwner(), equalTo(player));
            assertThat(card.getCardList(), equalTo(player.getHand()));
            assertThat(card.getId(), isBetween(CardMapping.RebelPlayableCards));
        }
        ...
        assertThat(currentBase.getOwner(), equalTo(player));
        assertThat(currentBase.getCardList(), is(nullValue()));
        assertThat(currentBase.getId(), isBetween(CardMapping.RebelBases));
        ...
        for (Base base : player.getAvailableBases()) {
            ...
            assertThat(base.getOwner(), equalTo(player));
            assertThat(base.getCardList(), equalTo(player.getAvailableBases()));
            assertThat(base.getId(), isBetween(CardMapping.RebelBases));
        }
    ...
    private void assertGalaxyState() {
        ...
        for (PlayableCard card : game.getGalaxyRow()) {
            assertThat(card.getId(), isBetween(CardMapping.getGalaxyCards(card.getFaction())));
            assertThat(card.getId(), isBetween(CardMapping.getPlayableCards(card.getFaction())));
            if (card instanceof CapitalShip) {
                assertThat(card.getId(), isBetween(CardMapping.getShipCards(card.getFaction())));
            }
    ...
    private void assertOuterRim() {
        ...
        for (PlayableCard card : game.getOuterRimPilots()) {
            assertThat(card.getId(), isBetween(CardMapping.NeutralOuterRimCards));
            assertThat(card.getId(), isBetween(CardMapping.NeutralPlayableCards));
