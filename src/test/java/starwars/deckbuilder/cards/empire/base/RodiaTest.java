...
class RodiaTest extends EmpireAvailableBaseTest implements HasOnRevealTest {
    ...
    public void preChooseBaseSetup() {
        rebel1 = (PlayableCard) game.getCardMap().get(REBEL_GALAXY_CARD);
        rebel2 = (PlayableCard) game.getCardMap().get(REBEL_GALAXY_CARD + 1);
        empire1 = (PlayableCard) game.getCardMap().get(EMPIRE_GALAXY_CARD);
        empire2 = (PlayableCard) game.getCardMap().get(EMPIRE_GALAXY_CARD + 1);
        neutral1 = (PlayableCard) game.getCardMap().get(NEUTRAL_GALAXY_CARD);
        neutral2 = (PlayableCard) game.getCardMap().get(NEUTRAL_GALAXY_CARD + 1);
